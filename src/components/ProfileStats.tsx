    ...
    <section className='mt-10 mb-7 min-w-[305px] max-w-md bg-light shadow-card rounded-2xl px-5 pt-5 pb-24'>
      ...
      <div className='flex flex-col gap-12 mt-5'>
        <div className='flex flex-col items-center gap-2'>
          ...
          <span className='text-primary text-sm px-5 py-1 font-main bg-primary-20 rounded-full'>ARTISTA</span>
        </div>

        <div className='flex flex-col items-center gap-5'>
          <h3 className='font-main font-[500] text-xl '>Resumen de estadísticas</h3>
          <ul className='flex flex-col items-center gap-8'>
            {profileStats.map(item => (
              <li key={item.id} className='flex flex-col items-center gap-2'>
                ...
                <span className='text-sm font-main text-center text-[#242731]'>{item.reason}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className='flex flex-col items-center gap-5'>
          <h3 className='font-main font-[500] text-xl text-deep'>Colaboradores</h3>
