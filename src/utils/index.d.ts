...
export declare namespace HttpProxy {
  ...
  export class Server extends events.EventEmitter {
    ...
    on(
      event: 'start',
      listener: (req: http.IncomingMessage, res: http.ServerResponse, target: ProxyTargetUrl) => void,
    ): this;
    on(
      event: 'proxyReq',
      listener: (
    ...
    on(
      event: 'proxyRes',
      listener: (proxyRes: http.IncomingMessage, req: http.IncomingMessage, res: http.ServerResponse) => void,
    ): this;
    on(
      event: 'proxyReqWs',
      listener: (
    ...
    on(
      event: 'econnreset',
      listener: (err: Error, req: http.IncomingMessage, res: http.ServerResponse, target: ProxyTargetUrl) => void,
    ): this;
    on(
      event: 'end',
      listener: (req: http.IncomingMessage, res: http.ServerResponse, proxyRes: http.IncomingMessage) => void,
    ): this;
    on(
      event: 'close',
      listener: (proxyRes: http.IncomingMessage, proxySocket: net.Socket, proxyHead: any) => void,
    ): this;
...
export declare function mergeConfig<D extends Record<string, any>, O extends Record<string, any>>(
...
declare interface Plugin_2 extends Plugin_3 {
   ...
   */
  config?: ObjectHook<
    (this: void, config: UserConfig, env: ConfigEnv) => UserConfig | null | void | Promise<UserConfig | null | void>
  >;
  /**
...
export declare type PluginOption =
  ...
  | undefined
  | PluginOption[]
  | Promise<Plugin_2 | false | null | undefined | PluginOption[]>;
...
export declare type PreviewServerHook = (
  this: void,
...
export declare type RenderBuiltAssetUrl = (
  filename: string,
  type: {
    type: 'asset' | 'public';
    hostId: string;
...
export declare type ResolvedConfig = Readonly<
  Omit<UserConfig, 'plugins' | 'css' | 'assetsInclude' | 'optimizeDeps' | 'worker' | 'build'> & {
...
export declare type ResolvedUrl = [url: string, resolvedId: string, meta: object | null | undefined];
...
export declare type ResolveModulePreloadDependenciesFn = (
  filename: string,
  deps: string[],
  context: {
    hostId: string;
...
export declare function sortUserPlugins(
  plugins: (Plugin_2 | Plugin_2[])[] | undefined,
): [Plugin_2[], Plugin_2[], Plugin_2[]];

export declare function splitVendorChunk(options?: { cache?: SplitVendorChunkCache }): GetManualChunk;
...
declare class WebSocket_2 extends EventEmitter {
  ...
  removeEventListener(method: 'message', cb: (event: WebSocket_2.MessageEvent) => void): void;
  removeEventListener(method: 'close', cb: (event: WebSocket_2.CloseEvent) => void): void;
  removeEventListener(method: 'error', cb: (event: WebSocket_2.ErrorEvent) => void): void;
  removeEventListener(method: 'open', cb: (event: WebSocket_2.Event) => void): void;
  ...
  on(event: 'upgrade', listener: (this: WebSocket_2, request: IncomingMessage) => void): this;
  ...
  on(
    ...
    listener: (this: WebSocket_2, request: ClientRequest, response: IncomingMessage) => void,
  ): this;
  ...
  once(event: 'upgrade', listener: (this: WebSocket_2, request: IncomingMessage) => void): this;
  ...
  off(event: 'upgrade', listener: (this: WebSocket_2, request: IncomingMessage) => void): this;
